...
BEGIN
    IS_AVAILABLE := USERPACKAGE.SEARCHBOOK(1055);
    DBMS_OUTPUT.PUT_LINE(IS_AVAILABLE);
END;

-- BORROW BOOK 
BEGIN
    USERPACKAGE.BORROWBOOK(1055, 2);
END;

-- RETURN BOOK 
BEGIN
    USERPACKAGE.RETURNBOOK(1055, 5);
END;

-- RESERVE BOOK
BEGIN
    USERPACKAGE.RESERVEBOOK(1055, 3);
END;
...
-- ADD BOOK
BEGIN
    STAFFPACKAGE.ADDBOOK('PLSQL Programming', 'A12R10', 3);
END;

-- DELETE BOOK
BEGIN
    STAFFPACKAGE.DELETEBOOK(1056, 26);
END;
