...
--DELETE FROM BORROWED_BOOKS WHERE B_BOOK_ID = 235;
--DELETE FROM RESERVED_BOOKS WHERE R_BOOK_ID = 164;
...
INSERT INTO LIBRARY_BOOKS (BOOK_NAME, BOOK_LOC, BOOK_COUNT) VALUES ('Cook Book', 'E16R50', 91);
