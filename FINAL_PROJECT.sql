...
CREATE TABLE RESERVED_BOOKS (
    ...
    BOOK_ID NUMBER(6),
    BOOK_NAME VARCHAR2(30),
    RESERVER_ID NUMBER(5),
    
    CONSTRAINT LIB_BOOKS_FK_RBOOKS
        FOREIGN KEY (BOOK_ID) REFERENCES LIBRARY_BOOKS(BOOK_ID),
        
    CONSTRAINT USER_FK_RBOOKS
        FOREIGN KEY (RESERVER_ID) REFERENCES USERS(USER_ID)
);
...
DROP SEQUENCE B_BOOKID_SEQ;
DROP SEQUENCE USERS_SEQ;
DROP SEQUENCE R_BOOKID_SEQ;
...
INSERT INTO LIBRARY_BOOKS (BOOK_NAME, BOOK_LOC, BOOK_COUNT) VALUES ('Cook Book', 'E16R50', 9);
